...
const About = (): ReactElement => {
  return (
    <>
      <Helmet>
        <title>About | CheckYourPitch - Free Ear Training</title>
        <meta
          name="description"
          content="Learn about CheckYourPitch - the free online pitch training platform. Discover our ear training games, and how we help musicians develop their musical ear."
        />
        <meta property="og:title" content="About | CheckYourPitch - Free Ear Training" />
        <meta
        ...
        <div className="about-page">
          <div className="container">
            ...
            <section className="about-section">
              ...
              <p>
                Voice pitch refers to how high or low a sound is. In music, pitch is the foundation of melody and
                harmony — it’s what allows us to recognize a song even when played on different instruments. Training
                your pitch perception helps you:
              </p>
              <ul>
            ...
            <section className="about-section">
              <h2>Get Started</h2>
              <p>
                Ready to begin your pitch‑training journey? Head back to the <a href="/">home page</a> and choose a
                game. Remember, developing your ear takes practice and patience — every expert was once a beginner!
              </p>
            </section>
          </div>
        </div>
