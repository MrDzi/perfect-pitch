...
const TermsConditions = (): ReactElement => {
  return (
    <>
      <Helmet>
        <title>Terms & Conditions | CheckYourPitch</title>
        <meta
          name="description"
          content="Read CheckYourPitch's Terms & Conditions. Learn about the rules and guidelines for using our free pitch training games and educational content."
        />
        <meta property="og:title" content="Terms & Conditions | CheckYourPitch" />
        <meta
        ...
        <div className="terms-conditions-page">
          <div className="container">
            ...
            <section className="terms-section">
              ...
              <p>
                These Terms & Conditions (&quot;T&C&quot;) govern your use of CheckYourPitch.com (the
                &quot;Website&quot; or &quot;Service&quot;) operated by CheckYourPitch (&quot;we,&quot; &quot;us,&quot;
                or &quot;our&quot;).
              </p>
              <p>
            ...
            <section className="terms-section">
              ...
              <p>
                By using this website, you certify that you are at least 13 years of age. If you are under 18, you
                confirm that you have your parent&#39;s or guardian&#39;s permission to use this website.
              </p>
            </section>
            ...
            <section className="terms-section">
              ...
              <p>
                You may use our website for personal, non-commercial purposes. You may not reproduce, distribute,
            ...
            <section className="terms-section">
              ...
              <p>
                While using our pitch detection games, audio may be processed locally in your browser. We do not store
                or retain any audio recordings you make while using our services.
              </p>
              <p>
            ...
            <section className="terms-section">
              ...
              <p>
                We use Google Analytics and Google AdSense, which may collect anonymous usage data and serve
            ...
            <section className="terms-section">
              <h2>Disclaimers</h2>
              <p>
                Our website and services are provided on an &quot;as is&quot; and &quot;as available&quot; basis. We
                make no warranties, expressed or implied, regarding:
              </p>
              <ul>
              ...
              <p>
                Musical training results vary by individual. Our games and exercises are educational tools and should
                not replace professional music instruction.
              </p>
            </section>
            ...
            <section className="terms-section">
              ...
              <p>
                ...
                posting to this page. Your continued use of the website after changes constitutes acceptance of the new
                Terms.
              </p>
            </section>
