...
const PrivacyPolicy = (): ReactElement => {
  useEffect(() => {
    document.title = "Privacy Policy | CheckYourPitch";
    // Update meta description for this page
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute(
        "content",
        "Read CheckYourPitch's privacy policy. Learn how we protect your data while you enjoy our free pitch training games and ear training exercises."
      );
    }
  }, []);
  return (
      ...
      <div className="privacy-policy-page">
        <div className="container">
          ...
          <section className="privacy-section">
            ...
            <h3>Audio Data</h3>
            <p>
              When you play some of our Pitch Checker game, your microphone input is processed directly in your browser.
            </p>
            <p>
            ...
            <p>
              We store only the melodies used in our games on our servers. These are not linked to any individual user.
            </p>
